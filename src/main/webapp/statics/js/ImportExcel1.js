function ImportExcel1($e, accepts) {
	this.$e = $e;
...
ImportExcel1.prototype.process = function(process) {
	if (process >= 0) {
...
ImportExcel1.prototype.do = function(evt) {
	if (this.lock) {
		return;
	}
	...
	xhr.open("POST", "/sendBatch/importOrderExcel", true);

...
<script type="text/javascript">
	$(function(){
		trHover('t2');
		 $('#add').click(function(){
			 $.dialog({lock: true,title:'新增优惠类型',drag: false,width:500,height:240,resize: false,max: false,content: 'url:${ctx}/mobile/csedit?layout=no',close: function(){
				 location.reload();
		  	 }});
		 });
	...
	function edit(id){
		 $.dialog({lock: true,title:'编辑优惠类型',drag: false,width:500,height:240,resize: false,max: false,content: 'url:${ctx}/mobile/csedit?id='+id+'&layout=no',close: function(){
			 location.reload();
	  	 }});
	}
...
<div class="tableble_search">
    ...
    <form:form id="trans" action="${ctx}/mobile/cstype" method="get">
    	<ul>

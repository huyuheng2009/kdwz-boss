    ...
    <script type="text/javascript">
      ...
      $('#print').click(function(){
            	...
            	if(s>200){
            		...
            		$.dialog({lock: true,title:'清单打印',drag: true,width:1200,height:600,resize: false,max: false,content: 'url:${ctx}/scan/revPrintPage?'+$("form:first").serialize()+'&layout=no',close: function(){
                 	 }}); 
            	}

...
<script type="text/javascript" src="/scripts/jquery.autocomplete.js"></script>
    ...
    function commit(id){
   	 $.ajax({type: "post",url:'/gather/commit',data:{'ids':id,'examineStatus':'2'},success:function(msg){
			 if(msg==1){
				 alert('提交成功');
				 location.reload();
			 }else{
            ...
            $('.select_all').click(function() {
               ...
               $('#batch_commit').click(function(){
               	...
               	if(ids.length>0){
               	 ...
               	 if(confirm("是否全部提交？")){
               		 $.ajax({type: "post",url:'/gather/commit',data:{'ids':ids,'examineStatus':'2'},success:function(msg){
                  			 if(msg==1){
                  				 alert('提交成功');
                  				 location.reload();
                  			 }else{
...
<div class="tableble_search">
    ...
    <form:form id="trans" action="${ctx}/gather/clist" method="get">

...
<div class="print_all">
 <div class="print_all_one"> 
   ...
   <div class="logo_right">
     ...
     <div class="print_com font_big " style="height: 60px;" >
       <div class="ji_left" style="width: 65%;text-align: center;overflow: hidden;padding: 0;margin-left: 1px;">
         <div class="barcode " style="overflow: hidden;"   no="${item.lgc_order_no }"></div>${item.lgc_order_no }
        </div>
        <div class="ji_right" style="width: 32%;overflow: hidden;font-size: 14px;padding: 14px 0px 0px 8px;display: inline-block;">寄件日期 <br /><fmt:formatDate value="${item.create_time}" pattern="yyyy-MM-dd" /></div>
     </div>
   ...
   <div class="print_com print_dd " style="height: 75px;">

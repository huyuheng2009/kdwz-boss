...
<div class="search">
    ...
    <form:form id="trans" action="${ctx}/settle/elist" method="post">
     <input type="hidden" name="serviceName" value=""/>
      ...
      <input type="hidden" name="settleStatus" value="1"/>
        <ul>
            ...
            <li style="margin-right: 200px;"><input class="button input_text  medium blue_flat sear_butt" 

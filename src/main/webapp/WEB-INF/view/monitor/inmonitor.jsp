...
<div class="search">
    ...
    <form:form id="trans" action="${ctx}/monitor/inmonitor" method="post" onsubmit="loaddata()">
     <input type="hidden" name="serviceName" value="monitor_inmonitor"/>
      <input type="hidden" name="ff" value="${params['ff']}"/>
        ...
        <textarea  cols="18" rows="4"   maxlength="1400" value="${orderNo}" placeholder="请输入运单号" name="orderNo"  class="order_area">${orderNo}</textarea> 							
             ...
             <li>网点名称：<input type="text" value="${params['cur_no']}" name="cur_no" id="substationNo" style="width: 300px;"></input></li>

                ...
                if ($("#myform").validationEngine("validate")) {
                    ...
                    if (money != null && money != '') {
                        if (money <= 300) {
                            ...
                            var options = {
                        url: '<%=request.getContextPath()%>/batchOrder/editOrderAddr',
                        dataType: 'json',
                        type: 'post',
        ...
        <form id="myform">
            <div class="out_new" style="padding: 0 0;">
                <div class="out_new_li" style="margin: 0;">
                    <div class="outnew_tit" style="margin: 0;"> <img src="<%=request.getContextPath()%>/statics/front/images/shou_icon.png" width="40" height="36"> <strong>收件人信息</strong> </div>
                    <div class="outnew_cont"  style="margin: 0;">
                        ...
                        <c:choose>
                            <c:when test="${orderAddr.id != 0 && (orderAddr.revArea == null || orderAddr.revArea == '')}">
                            </c:when>
                            <c:otherwise>
                                <div class="input_li">
                                    <div class="input_name"><b>*</b>省市区</div>
                                    <div class="input_wri">
                                        <input type="text" id="revArea" name="revArea" placeholder="请选择收件地址" class="validate[required]" value="${orderAddr.revArea}" onfocus="cit.fouse('down_addrRev', 'revUl')" data-errormessage-value-missing="* 请选择收件地址">

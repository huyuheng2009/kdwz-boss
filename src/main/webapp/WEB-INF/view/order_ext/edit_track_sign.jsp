    		           ...
    		           url: "/order_ext/take_update",//要访问的后台地址
    		            data: {'sendSubstationNo':send_substation_no,'returnType':return_type,'itemStatus':itemStatus,'timeType':agingType,
    		            	'lgcOrderNo':lgcOrderNo,'sendName':sendName,'sendPhone':sendPhone,'sendArea':'','sendAddr':sendAddr,'sendKehu':sendKehu,
    		            	   ...
    		            	   'receNo':receNo,'orderNote':orderNote,'sendCourierNo':take_courier_no,'itemCount':item_count,'subStationNo':subStationNo,
    		            	...
    		            	'payType':payType,'disUserNo':disUserNo,'pwd':pwd,'tnpay':tnpay,'reqRece':reqRece,'forNo':forNo,'tdate':tdate,'sign':'Y'
    		            },//要发送的数据
    		           beforeSend:loading,
    ...
    <div class="check_cont">
      ...
      <div class="check_li">
        ...
        <div class="check_li">
          ...
          <div class="soso_input">
                  <input disabled="disabled" value="${orderMap.take_courier_no}"  type="text"  maxlength="50">
                  <input type="text"  disabled="disabled"  value='<u:dict name="C" key="${orderMap.take_courier_no}" />' >
          </div>
        </div>
        ...
        <div class="check_li">
          ...
          <div class="soso_input">
                  <input id="take_courier_no" class="validate[required,funcCall[zys]]" name="take_courier_no" value="${orderMap.send_courier_no}"  type="text"  maxlength="50">
                  <input class=" " type="text" name="take_courier_name" id="take_courier_name" disabled="disabled"  value='<u:dict name="C" key="${orderMap.send_courier_no}" />' >
          </div>
        </div>
      ...
      <div class="check_cont_left check_cont_right02">
          ...
          <div class="soso_input">
             <input  type="text" disabled="disabled"  name="tdate1" value="${params['tdate']}" />
          </div>
        </div>
        ...
        <div class="check_li">
          ...
          <div class="soso_input">
             <input id="tdate" onFocus="WdatePicker({isShowClear:false,dateFmt:'yyyy-MM-dd  HH:mm',readOnly:true,maxDate:'#F{\'%y-%M-%d %H:%m\'}'})" <c:out value="${orderMap.sign_examine_status eq 'PASS' ?'disabled':'' }"/>  type="text"  name="tdate" value="${params['sdate']}" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})"/>
          </div>
        </div>
       <div class="check_li">

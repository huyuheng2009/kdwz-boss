    ...
    <head>
        ...
        <script>
			function importSubstation() {
				...
				$("form:first input[name=serviceName]").val('dayCourierExport2');
...
//                });
    ...
    <body>
        <div class=" soso"><!--按钮上下结构-->    
            <!--按钮左右结构-->
            <div class="soso_left">  	  
                <form id="myform" action="queryDayCourierInfo2" method="post" onsubmit="loaddata()">
                    <div class="soso_li">
                        <div class="soso_b">账单时间</div>
                        <div class="soso_input">
                            <input type="hidden" name="serviceName" value="" />
                            <input type="hidden" name="ff" value="${params['ff']}"/>
                            <input type="hidden" name="unfor" value="1"/>

...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class=" soso"><!--按钮上下结构-->    
            <!--按钮左右结构-->
            <div class="soso_left">  	  
                <form id="myform" action="queryDaySubstationInfo" method="post" onsubmit="loaddata()">
...
<!--                                                        <td>${item.dtotalMoney}</td>-->
                                                        ...
                                                        <td><c:choose>
                                                                ...
                                                                <c:when test="${item.dmemberMoney == null && item.jmemberMoney == ''}"><fmt:formatNumber value="${item.jmemberMoney}" pattern="#,##0.00#" /><c:set var="jmember" value="${item.jmemberMoney}"></c:set></c:when>
...
<!--                                                    <td>${mapcount.dtotalMoney}</td>  -->
                                                    ...
                                                    <td><c:if test="${mapcount.total == null}">0.00</c:if><fmt:formatNumber value="${mapcount.jcashMoney+mapcount.jmonthMoney+mapcount.jmemberMoney+mapcount.dgoodMoney}" pattern="#,##0.00#" /></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>

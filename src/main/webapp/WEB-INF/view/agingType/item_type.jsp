...
<script type="text/javascript">
	$(function(){
		trHover('t2');
		 $('#add').click(function(){
			 $.dialog({lock: true,title:'新增时效类型',drag: false,width:500,height:170,resize: false,max: false,content: 'url:${ctx}/aging/type_edit?layout=no',close: function(){
				 location.reload();
		  	 }});
		 });
	...
	function edit(id){
		 $.dialog({lock: true,title:'编辑时效类型',drag: false,width:500,height:170,resize: false,max: false,content: 'url:${ctx}/aging/type_edit?id='+id+'&layout=no',close: function(){
			 location.reload();
	 	 }});
	}
...
<div class="tableble_search">
    ...
    <form:form id="trans" action="${ctx}/aging/item_type" method="get">
    	<ul>
            <li>时效类型：<input type="text" value="${params['itemText']}" name="itemText"></input></li>

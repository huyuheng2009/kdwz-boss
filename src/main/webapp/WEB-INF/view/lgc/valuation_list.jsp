...
<script type="text/javascript">
	$(function(){
		trHover('t2');
		 $('#add').click(function(){
			 $.dialog({lock: true,title:'新增规则',drag: false,width:600,height:300,resize: false,max: false,content: 'url:${ctx}/lgc/valuation_edit?layout=no',close: function(){
				 location.reload();
		  	 }});
		 });
	...
	function edit(id){
		 $.dialog({lock: true,title:'编辑规则',drag: false,width:600,height:300,resize: false,max: false,content: 'url:${ctx}/lgc/valuation_edit?id='+id+'&layout=no',close: function(){
			 location.reload();
	 	 }});
	}
	...
	function status(id){
		 if(confirm('确定应用此规则吗？')){
			 $.ajax({url:'valuation_status',data:{'id':id},success:function(msg){
				 if(msg==1){
					 alert('保存成功');
					 location.reload();
				 }else{
...
<div class="tableble_search">
    ...
    <form:form id="trans" action="${ctx}/lgc/valuation_rule" method="get">
    	<ul>
...
<div class="tbdata">
	...
	<table width="100%" cellspacing="0" class="t2" id="t2">
        ...
        <tr>
            ...
            <th align="center">保价最低额</th>
            <th align="center">保价最高额</th>

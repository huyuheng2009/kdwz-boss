...
<script type="text/javascript">
	...
	jQuery.ajax({
       ...
       $("#export").click(function(){
    	   ...
    	   form.attr("action","/disuser/export1");
    	   form.submit();
...
<div class="tableble_search">
    ...
    <form:form id="trans" action="${ctx}/disuser/rlist" method="get">
    	<ul>
    	<li><span>登记时间：</span>
		...
		<%-- 	  <div class="clear"></div>
            ...
            <div  style="color: white;background-color: gray;height:30px;display: inline-block;line-height: 30px;margin-left: 10px;padding: 0 10px;min-width: 100px;" id="stips">&#12288;&#12288;&#12288;&#12288;</div>
             ...
             <li>收款人：<input  name="gatherNo" id="gatherNo"  value="${params['gatherNo']}" style="width: 200px;"  type="text"/>
            <div  style="color: white;background-color: gray;height:30px;display: inline-block;line-height: 30px;margin-left: 10px;padding: 0 10px;min-width: 100px;" id="gtips">&#12288;&#12288;&#12288;&#12288;</div>
            </li> --%>
	...
	<table width="100%" cellspacing="0" class="t2" id="t2">
        ...
        <c:forEach items="${list.list}" var="item" varStatus="status">
            <tr class="${status.count % 2 == 0 ? 'a1' : ''}">
                ...
                <td>${item.omoney}</td>
                  <td><c:if test="${item.gather_no_type eq 'C' }">${item.real_name}</c:if>
                    <c:if test="${item.gather_no_type ne 'C' }">${item.gather_no}</c:if>
                </td>

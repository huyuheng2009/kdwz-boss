...
<body>
	<div class="table" >
		<div class="ta_header">
			<form action="noInhaveOutSend?layout=no" method="post">
				...
				<input type="hidden" name="serviceName" value="noInhaveOutSend" />
			...
			<table class="ta_ta" width="100%" cellpadding="0" cellspacing="0"
				...
				<thead>
					<tr>
						...
						<th width="50" align="center">派件时间</th>
						<th width="50" align="center">派件网点</th>					
						<th width="50" align="center">派件网点名称</th>
						<th width="50" align="center">快递员</th>
						<th width="30" align="center">快递员名称</th>
					</tr>
				</thead>
				<tbody>	

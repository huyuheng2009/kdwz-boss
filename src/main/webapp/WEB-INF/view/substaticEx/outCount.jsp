...
<body>
	<div class="table" style="width: 800px;">
		<div class="ta_header">
			<form action="outCount?layout=no" method="post">
				...
				下一站编号 <input class="put_cont" type="text" name="substationNo" id = "substationNo"	
				...
				<input type="hidden" name="serviceName" value="outCount" />

	 ...
	 $('#submit').click(function(){
		 ...
		 $.ajax({
			 type: "post",//使用get方法访问后台
	            ...
	            url: "${ctx }/client/vp_save",//要访问的后台地址
	            data: {'vid':$('#vid').val(),'ids':ids},//要发送的数据
...
<body>
	 <div class="content">
	 <form action="${ctx }/client/vp_save" method="post">
	 	<div class="item">
	 		 <input  type="hidden" id="vid" name="vid" value="${params.id }"/>

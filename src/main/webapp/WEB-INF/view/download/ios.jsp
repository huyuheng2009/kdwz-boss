    ...
    <div class="dl_cont">
        ...
        <div class="dl_down">
            <div class="dl_down_no">
                <div class="dl_p_icon"><img src="/themes/default/images/ios.png"></div>
                               <div class="dl_button"><a  href="itms-services://?action=download-manifest&url=${app.downloadAddress}" class="button" >下载安装</a></div>
            </div>

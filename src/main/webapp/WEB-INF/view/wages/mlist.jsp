...
<script type="text/javascript" src="/scripts/jquery.autocomplete.js"></script>
   ...
   function edit(bid){
   	$.dialog({lock: true,title:'费用编辑',drag: true,width:1000,height:550,resize: false,max: false,content: 'url:${ctx}/wages/edit?bid='+bid+'&layout=no',close: function(){
   	 }});
   }
        $(function () {
            trHover('t2');
...
<div class="search">
    ...
    <form:form id="trans" action="${ctx}/wages/mlist" method="post">
     <input type="hidden" name="serviceName" value="wagesMlist"/>
    ...
    <table width="100%" cellspacing="0" class="t2" id="t2">
        ...
        <c:forEach items="${list.list}" var="item" varStatus="status">
          ...
          <c:forEach items="${nameList}" var="item1" varStatus="status1">  
            ...
            <td><a href="javascript:edit('${item.batch_id}');">编辑</a></td>     
            </tr>
        </c:forEach>
        </tbody>
    </table>

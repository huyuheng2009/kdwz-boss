var softKeyIsIE9 = (navigator.userAgent.toLowerCase().indexOf("msie 9.0") != -1);
var password1;
var CapsLockValue=0;
var checkSoftKey;
var pIsPWD=false;
...
//	@condition：无
//**************************************************************
style1+=".btn_letter { font: 12px '宋体',Tahoma;color: #075BC3;text-align:center; BORDER-RIGHT: 1px solid; BORDER-TOP: 1px none; FONT-SIZE: 18px; BORDER-LEFT: 1px none; CURSOR: pointer; BORDER-BOTTOM: 1px none; width:25px; height:21px;line-height:21px; }";
...
{
if(softKeyIsIE9) {
	document.getElementById("Calc").childNodes[0].childNodes[0].childNodes[0].style.backgroundColor="#B5ADF1";
} else {

 ...
 <link rel="shortcut icon" href="${ctx}/themes/default/lgc_logo/${lgcConfig.key}_title.png">
...
<link rel="stylesheet" type="text/css" href="${ ctx}/themes/default/default.css" />
...
<!--  å¬ç¨jsæ¨¡å  -->
 ...
 function checkPhone(phone,isCall){
	 var p = /^(17[0-9]|13[0-9]|14[0-9]|15[0-9]|18[0-9])\d{8}$/ ;      //ææºå·ç 

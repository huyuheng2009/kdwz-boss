...
@Service
public class CourierCostRecordService {
	@Resource
	private BaseDao baseDao;
	
	
	public void save(CourierCost courierCost){
		baseDao.insert("CourierCostRecord.insert", courierCost);
	}
	
	
	public void batchSave(List<CourierCost> courierCosts){
		if (courierCosts!=null&&courierCosts.size()>0) {
			baseDao.insert("CourierCostRecord.batchInsert", courierCosts);
		}
	}
	...
	public PageInfo<Map<String, Object>> list(Map<String, String> params, Page pageInfo) {
		...
		PageInfo<Map<String, Object>> page = baseDao.getByPage("CourierCostRecord.list", pageInfo, params);
		return  page;
	}
	...
	public List<Map<String, Object>> list(Map<String, String> params) {
		String nameSql = getNameSql() ;
		params.put("nameSql", nameSql) ;
		List<Map<String, Object>> list = baseDao.getList("CourierCostRecord.list", params);
		return  list;
	}
	...
	public Map<String, Object> getByBid(String batch_id) {
		...
		return  baseDao.getFrist("CourierCostRecord.getByBid", params);
	}

	public boolean  isExist(CourierCost courierCost) {
		boolean flag = false ;
	  Map<String, Object>	map =  baseDao.getFrist("CourierCostRecord.getByCm", courierCost);
	  if (map!=null) {
		 flag = true ;
	  }
	  return flag ;
	...
	public void deleteByBid(String batch_id){
		...
		baseDao.deleteByParams("CourierCostRecord.deleteByBid", pMap);
	}

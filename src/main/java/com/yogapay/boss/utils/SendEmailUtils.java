...
public static void sendMessage(String smtpHost, String from,String fromUserPassword, String to, 
		String subject,	String messageText, String messageType) throws MessagingException {
...
public static void main(String[] args) {
	try {
		SendEmailUtils.sendMessage("smtp.exmail.qq.com", "",
				"", "", "nihao",
				"---------------wrwe-----------",
